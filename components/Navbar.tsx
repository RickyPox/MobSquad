              ...
              <div className="flex-1 flex items-center justify-between ">
                <div className="flex-shrink-0 flex items-center">
                  <a href="#" className='flex  '>
                    <img src='/Mobsquad.svg' className='transition-all ease-in-out duration-150' id="navbar_logo"></img>
                    <svg className="block transition-all ease-in-out duration-150" id="navbar_icon" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" viewBox="0 0 80 100">
                  ...
                  <div className="flex xl:space-x-10 items-center justify-center text-center">
                    {navigation.map((item) => (
                      <a
                        ...
                        'text-white font-[Poppins] font-semibold p-[10px] font-regular text-[16px] hover:text-[#98DABC] transition-all ease-in-out duration-150'
                        )}
